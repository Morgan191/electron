...
class AppFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        $recrutement->setNom('Dupont')->setPrenom('Jean')->setEmail('jean@example.com')->setPassword('hashedpassword');

        $recrutement2 = new Recrutement2();
        $recrutement2->setDateNaissance(new \DateTime('2000-01-01'))
            ->setAdresse('10 rue Exemple')
            ->setTelephone(123456789)
            ->setNationalite('Française')
            ->setEcoleActuelle('Université')
            ->setNomCursus('Informatique')
            ->setSpecialite('Développement')
            ->setDateEntreeCursus(new \DateTime('2018-09-01'))
            ->setAnneeCursus(3)
            ->setCarteEtudiant('1234567890')
        ...
        $user->setRecrutement($recrutement);
        $manager->persist($user);



        $recrutement = new Recrutement();
        $recrutement->setNom('Dupont')->setPrenom('Jean')->setEmail('jean2@example.com')->setPassword('hashedpassword');
        ...
        $recrutement3->setSujetRecherche('AI Research')
            ->setCv('cv.pdf')
            ->setVideo('video.mp4')
            ->setRecrutement2($recrutement2);

        $recrutement2->setRecrutement3($recrutement3);
        $recrutement->setRecrutement2($recrutement2);

       
        $manager->persist($recrutement);
        $manager->persist($recrutement2);
        $manager->persist($recrutement3);
